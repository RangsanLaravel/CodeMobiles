...
import { Product, ResponseProducts, ResponseProduct } from '../models/product.model';
import { ResponseRegister, ResponseLogin } from '../models/auth.model';
...
export class NetworkServiceService {
  ...
  editProduct(data,id:Number) :Observable<ResponseProduct>{
    return this.httpClient.put<ResponseProduct>(`${this.productURL}/${id}`,this.makeFormData(data));
  }
}
